...
______________________________________________________________________________________________
  ...
  following 3 algorithms:
  (1) Kruskal's Algorithm to compute a Minimum Spanning Tree for the graph.
  (2) Dijkstra's Algorithm to compute the shortest paths from a given source node to all other
      nodes in the graph.
  (3) Depth First Search algorithm for graph traversl.
  
	Kruskal's Algorithm uses a minimum heap class "MinHeap" to select edges with minimum weight.
